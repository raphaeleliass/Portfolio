...
function Skills() {
  return (
    <section className="mx-auto mt-32 flex w-full max-w-xs flex-col gap-12 border-t-2 border-gray-200 dark:border-neutral-700 py-12 md:max-w-3xl lg:max-w-6xl">
