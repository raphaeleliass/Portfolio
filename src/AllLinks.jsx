...
function AllLinks() {
  return (
    <section className="flex min-h-screen w-screen items-center justify-center">
      <div className="m-4 flex w-full flex-col gap-12 rounded-3xl bg-customDarkGrey p-8 py-12 md:w-[500px] md:gap-12 md:p-12 lg:w-[500px] lg:gap-12 lg:p-12">
        <div className="flex flex-row items-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            <h2 className="font-Inter text-sm text-customGrey">
              Front-End Developer
            </h2>
          </div>
        </div>
        ...
        <div className="flex w-full flex-col">
          <div className="">
            <ul className="flex flex-col gap-6">
              <li className="items-center rounded-full border border-neutral-700 px-6 py-1 transition-all hover:bg-customGrey hover:font-bold hover:text-customBlack">
                <Link
                  ink
                  to="/"
